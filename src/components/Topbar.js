    ...
    return (
        <header className="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
            <div className="flex items-center">
                <button onClick={() => props.toggleSidebar()} className="text-gray-500 focus:outline-none lg:hidden">
...
{/* 
                    <div x-show="notificationOpen" onClick={"notificationOpen = false"} className="fixed inset-0 h-full w-full z-10"></div> */}

                    {notificationOpen &&

                    <div x-show="notificationOpen" className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl overflow-hidden z-10" style={{width:'20rem'}}>
                ...
                <div x-data="{ dropdownOpen: false }"  className="relative">
                    ...
                    {dropdownOpen &&
                    <div x-show="dropdownOpen" className="absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10">
